...
class Color(object):
  ...
  # Definición de suma entre colores.
  def __add__(self, other):

    # Valores actuales del objeto color.
    r, g, b = self.r, self.g, self.b

    # Los colores suamados por números aumentan o disminuyen en función del número.
    if ((type(other) == int) or (type(other) == float)):
      r += other
      g += other
      b += other

    # Si el color se suma por otro, se suman sus tres valores.
    else:
      r += other.r
      g += other.g
      b += other.b
